# Generated by Django 5.0.3 on 2024-04-05 19:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping', models.CharField(choices=[('C1', 'Cart'), ('C2', 'Completed')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='BackendWork.product')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cart_item', to='BackendWork.cart')),
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(through='BackendWork.CartItem', to='BackendWork.product'),
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_image', to='BackendWork.product')),
            ],
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite', models.ManyToManyField(to='BackendWork.product')),
